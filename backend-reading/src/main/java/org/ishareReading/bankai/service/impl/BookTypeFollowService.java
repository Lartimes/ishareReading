...
//书籍类型
@Service
public  class BookTypeFollowService extends ServiceImpl<UserFollowingMapper, UserFollowing> implements FollowInterface {
    public static final String CURRENT_TYPE = "books";
    @Autowired
